...
final class CameraConfigurationManager {
  ...
  void initFromCameraParameters(Camera camera) {
    ...
    theScreenResolution.x = dm.widthPixels;
    theScreenResolution.y = dm.heightPixels;
  ...
  @SuppressLint("InlinedApi") void setDesiredCameraParameters(Camera camera, boolean safeMode) {
    Camera.Parameters parameters = camera.getParameters();
    ...
    if (safeMode && VERSION.SDK_INT < 14) {
