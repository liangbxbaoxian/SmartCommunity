...
public class SetLocationActivity extends BaseActivity implements OnMenuItemClickListener, Listener<OneKm>, 
	...
	private void getGps() {
		...
		mLocationClient.registerLocationListener(new BDLocationListener() {
			...
			public void onReceiveLocation(BDLocation arg0) {
				...
				requestBase(getBaseRequestParams(), SetLocationActivity.this, SetLocationActivity.this);
			}
...
//				new GetDataTask().execute();
		...
		mPullToRefreshListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(SetLocationActivity.this, SetLocationDetailActivity.class);
		...
		initData();
		mAdpter = new MsgAdapter(SetLocationActivity.this, list);
