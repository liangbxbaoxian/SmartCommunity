...
import com.wb.sc.parser.OneKmDetailParser;
import com.wb.sc.parser.OneKmParser;

public class OneKmRequestDetail extends ParamsEncryptRequest<OneKmDetail> {
	public OneKmRequestDetail (String url, List<String> params, 
			Listener<OneKmDetail> listenre, ErrorListener errorListener) {
		super(url, params, listenre, errorListener);
	}
	
	@Override
	protected Response<OneKmDetail> parseNetworkResponse(NetworkResponse response) {
